      ...
      <div style={layout}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', width: '100%', border: '1px solid #ccc', borderRadius: '10px', color: '#757575' }}>
          <div style={{ backgroundColor: 'white', flex: '1', borderBottomLeftRadius: '10px', borderTopLeftRadius: '10px', padding: '1rem' }}>
            <div style={styles.wrapper}><p style={styles.text}>Team name: </p><Input type='text' value={this.state.name}/></div>
            <div style={styles.wrapper}><p style={styles.text}>Team description: </p><Input.TextArea type='text' value={this.state.description} autosize={{ minRows: 10 }} /></div>
          </div>
          <div style={{ backgroundColor: 'white', flex: '1', borderTopRightRadius: '10px', borderBottomRightRadius: '10px', padding: '1rem' }}>
            <div style={styles.wrapper}><p style={styles.text}>Team password: </p><Input.Password value={this.state.decryptPass} autoComplete='new-password' type='password' /></div>
            <div style={styles.wrapper}>
              <div style={{ flex: 1, padding: '1rem 0' }}>
                <div style={styles.wrapperC}><p style={styles.text}>Team ID: </p><Paragraph copyable={{ text: '42jf1k23ll18d92' }} style={{ margin: 0 }}>42jf1k23ll18d92</Paragraph></div>
              ...
              <div style={{ flex: 1, padding: '1rem 0' }}>
                <div style={styles.wrapperC}>
                  ...
                  <p style={styles.textC}>Enable private team <span>
                ...
                <div style={styles.wrapperC}><Switch defaultChecked={true} />
                  <p style={styles.textC}>Enable logs <span>
                ...
                <div style={styles.wrapperC}><Switch defaultChecked={this.state.adminApproval} />
                  <p style={styles.textC}>Enable member approval <span>
