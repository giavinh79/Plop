...
export default function HomepagePrivacyTerms({ setDisplayPrivacyModal }) {
  return (
    ...
    >
      <div style={{ maxHeight: '30rem', overflowY: 'scroll', paddingRight: '2rem' }}>
        <p>
          At Plop, accessible from https://plop.team, one of our main priorities is the privacy of our visitors. This
          Privacy Policy document contains types of information that is collected and recorded by Plop and how we use
          it.
        </p>
        <p>
        ...
        <p>
          Plop legal basis for collecting and using the personal information described in this Privacy Policy depends on
          the Personal Information we collect and the specific context in which we collect the information:
        </p>
        <ul>
          <li>Plop needs to perform a contract with you</li>
          <li>You have given Plop permission to do so</li>
          <li>Processing your personal information is in Plop legitimate interests</li>
          <li>Plop needs to comply with the law</li>
        </ul>
        <p>
          Plop will retain your personal information only for as long as is necessary for the purposes set out in this
          Privacy Policy. We will retain and use your information to the extent necessary to comply with our legal
          obligations, resolve disputes, and enforce our policies. Our Privacy Policy was generated with the help of{' '}
          <a href='https://www.gdprprivacynotice.com/'>GDPR Privacy Policy Generator</a> and the{' '}
          <a href='https://www.gdprcontracts.com/gdpr-privacy-policy-generator/'>GDPR Privacy Policy Generator</a>.
        </p>
        <p>
        ...
        <h2>Log Files</h2>
        <p>
          Plop follows a standard procedure of using log files. These files log visitors when they visit websites. All
        ...
        <p>
          Like any other website, Plop uses 'cookies'. These cookies are used to store information including visitors'
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Plop.</p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
          in their respective advertisements and links that appear on Plop, which are sent directly to users' browser.
        ...
        <p>Note that Plop has no access to or control over these cookies that are used by third-party advertisers.</p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          Plop's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
        ...
        <p>
          Plop does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
        ...
        <p>
          ...
          to the information that they shared and/or collect in Plop. This policy is not applicable to any information
