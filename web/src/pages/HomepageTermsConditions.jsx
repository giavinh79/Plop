...
export default function HomepageTermsConditions({ setDisplayTermsModal }) {
  return (
    <Modal
    ...
    >
      <div style={{ maxHeight: '30rem', overflowY: 'scroll', paddingRight: '2rem' }}>
        <p>
          This website is operated by Plop. Throughout the site, the terms “we”, “us” and “our” refer to Plop. Plop
          offers this website, including all information, tools and services available from this site to you, the user,
        ...
        <p>
          ...
          forward to us. We are and shall be under no obligation (1) to maintain any comments in confidence; (2) to pay
        ...
        <p>
          ...
          Privacy Policy, please click on 'Privacy' in the site's footer.
        </p>
        ...
        <p>
          ...
          that will or may be used in any way that will affect the functionality or operation of the Service or of any
          ...
          to interfere with or circumvent the security features of the Service or any related website, other websites,
          or the Internet. We reserve the right to terminate your use of the Service or any related website for
        ...
        <p>
          ...
          all products and services delivered to you through the service are (except as expressly stated by us) provided
        ...
        <p>
          In no case shall Plop, our directors, officers, employees, affiliates, agents, contractors, interns,
          ...
          incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent
          permitted by law.
        </p>
        <h2>SECTION 12 - INDEMNIFICATION</h2>
        <p>
          You agree to indemnify, defend and hold harmless Plop and our parent, subsidiaries, affiliates, partners,
          ...
          due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference,
        ...
        <h2>SECTION 16 - CHANGES TO TERMS OF SERVICE</h2>
        ...
        <p>Questions about the Terms of Service should be sent to us at plopwebapp@gmail.com.</p>
      </div>
    </Modal>
  );
}
